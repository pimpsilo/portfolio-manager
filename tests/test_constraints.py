...
def test_hard_constraints_and_caps():
    ...
    # With only 5 non-avoid assets and 25% cluster caps, max possible equity is 58.18%
...
def test_diversified_portfolio_full_budget():
    ...
    # In a diversified 10-asset universe, equity reaches exactly the 90% budget (10% cash reserve)
